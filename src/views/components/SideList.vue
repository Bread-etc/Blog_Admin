...
<template>
  <div>
    <ul class="flex flex-col m-0 p-0">
      <li v-for="item in guideList" class="list-none m-3 text-gray-400 flex flex-row justify-item-center items-center text-base font-bold cursor-pointer" id="item-li"  @click="directTo(item.url)">
